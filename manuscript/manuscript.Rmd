...
```{r, echo=FALSE, fig.cap="Figure 4. Number of species in each year of the study period. Note that this is not a comprehensive list of all Odonates at the site, this will be addressed in the discussion."}
...
As seen in Table 2, five of the ten species modelled changed significantly in their abundances over the study period. Two of those, *P. nymphula* and *L. quadrimaculata* decreased over the study period, with *P. nymphula* no longer reported starting in the mid-sixties (Fig. 3). 
